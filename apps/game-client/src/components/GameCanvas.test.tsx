    ...
    const handle: GameRuntimeHandle = {
      ...
      getDiagnostics: vi.fn(() => ({
        ...
        camera: {
          ...
          bounds: { minX: 0, minY: 0, maxX: 1_536, maxY: 960 },
        },
        culling: {
          activeTerrainChunks: 1,
          totalTerrainChunks: 1,
          visibleTerrainNodes: 1,
          totalTerrainNodes: 1,
          visibleTerrainAuxiliaryNodes: 1,
          totalTerrainAuxiliaryNodes: 1,
          visibleObjects: 1,
          totalObjects: 1,
        },
        collision: { nearbyShapes: 0, totalShapes: 0, playerFootRadius: 0.24 },
