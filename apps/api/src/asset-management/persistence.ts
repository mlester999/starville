...
const rawAssetSchema = z
  .object({
    ...
    bundledManifestVersion: z
      ...
      .regex(/^[0-9]+\.[0-9]+\.[0-9]+$/u)
      .nullable(),
    activeSourceState: z.enum(['unavailable', 'bundled_default', 'uploaded_override']),
...
function projectAsset(value: unknown): AssetSummary {
  ...
  return assetSummarySchema.parse({
    ...
    bundledDefaultVersionId: raw.bundledDefaultVersionId,
    bundledManifestVersion: raw.bundledManifestVersion,
    activeSourceState: raw.activeSourceState,
    canRestoreBundledDefault: raw.canRestoreBundledDefault,
    developmentMarkerReplacementKey: raw.developmentMarkerReplacementKey,
    versionCount: raw.versionCount,
    uploadedVersionCount: raw.uploadedVersionCount,
    invalidVersionCount: raw.invalidVersionCount,
    referenceCount: raw.referenceSummary.total,
    referenceBreakdown: raw.referenceBreakdown,
